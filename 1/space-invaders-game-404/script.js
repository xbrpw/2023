  ...
  Game.prototype = {
    ...
    draw: function() {
      ...
      if (this.lost) {
        ...
        screen.font = "25px Lucida Console";
        screen.textAlign = "center";
        screen.fillStyle = "white";
        screen.fillText("You lost, Sashay Away", gameSize.width / 2, gameSize.height / 2);
        screen.font = "20px Lucida Console";
        screen.fillText("Score:" + kills, gameSize.width / 2, gameSize.height / 2 + 40);
        ...
        screen.fillText("Score: " + kills, gameSize.width, gameSize.height - 12);
      }
