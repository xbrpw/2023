...
//  alertify.log('<div style="font-size: 14px; text-align: center;"><img src="https://michaelsboost.com/TouchDrawer/logo.svg" style="width: 50%;"><br><h1>TouchDrawer</h1><h5>Version 1.000-alpha</h5></div>');
  
  swal({
    html: '<img src="https://michaelsboost.com/TouchDrawer/logo.svg" style="width: 50%;"><br><h1>TouchDrawer</h1><h5>Version 1.000-alpha</h5><a href="https://github.com/michaelsboost/TouchDrawer/blob/gh-pages/LICENSE" target="_blank">Open Source License</a>'
  });
